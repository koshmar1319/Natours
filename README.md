...
<kbd> <img width="900" height="auto" align="center" alt="Превью проекта" src="./natours_preview.jpg"> </kbd>

### Описание:
Проект для путешественников, которые хотят посетить разные уголки планеты.
...
```sh
git clone https://github.com/koshmar1319/Natours.git
```
...
### Демо:
> Github Pages <br/>[Ссылка на сайт :arrow_lower_right:](https://koshmar1319.github.io/projects/Natours/index.html "ссылка на сайт")
